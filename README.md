...
*  Haga la especificación de los métodos calculateScore (de las tres
   ...
   @pos, @param, @throws.(Interface,gamescore)

* Actualice el archivo `pom.xml` e incluya las dependencias para la ultima versión de JUnit y la versión del compilador de Java a la versión 8 .(pomJUnit)
...
1. Utilizando el HangmanFactoryMethod (MétodoFabrica) incluya el
   OriginalScore a la configuración.(HangmanFactoryMethod)

Incorpore el Contenedor Liviano Guice dentro del proyecto:

* Revise las dependencias necesarias en el pom.xml.(pomGuice)

* Modifique la inyección de dependencias utilizando guice en lugar del
  método fábrica..(CreateGui)
...
* Mediante la configuración de la Inyección de
  ...
  ejemplo:
	* Utilizar el esquema OriginalScore.(GOriginalScore)
